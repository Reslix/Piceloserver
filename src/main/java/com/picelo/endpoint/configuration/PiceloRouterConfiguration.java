...
import com.picelo.endpoint.handler.FolderHandler;
import com.picelo.endpoint.handler.ImageHandler;
import com.picelo.endpoint.handler.ImageRankingHandler;
import com.picelo.endpoint.handler.LoginHandler;
import com.picelo.endpoint.handler.TagHandler;
import com.picelo.endpoint.handler.UserHandler;
import com.picelo.endpoint.metrics.RouteMetricsFilter;
...
@Configuration
public class PiceloRouterConfiguration {

    private final RouteMetricsFilter routeMetricsFilter;

    @Autowired
    public PiceloRouterConfiguration(final RouteMetricsFilter routeMetricsFilter) {
    ...
    public RouterFunction<ServerResponse> imageRankingRoute(final ImageRankingHandler imageRankingHandler) {
        ...
        var postRankingStepsPredicate = RequestPredicates.POST("/api/imageranking/step/")
                .and(RequestPredicates.accept(MediaType.APPLICATION_JSON));
        var postImageRankingStatePredicate = RequestPredicates.POST("/api/imageranking/state/")
                .and(RequestPredicates.accept(MediaType.APPLICATION_JSON));
        ...
        var deleteImageRankingPredicate = RequestPredicates.DELETE("/api/imageranking/")
                .and(RequestPredicates.accept(MediaType.APPLICATION_JSON));
        var deleteImageRankingStatePredicate = RequestPredicates.DELETE("/api/imageranking/state/")
                .and(RequestPredicates.accept(MediaType.APPLICATION_JSON));
        return RouterFunctions.route(postImageRankingPredicate, imageRankingHandler::createImageRanking)
                ...
                .andRoute(postImageRankingStatePredicate, imageRankingHandler::uploadRankingState)
                ...
                .andRoute(deleteImageRankingPredicate, imageRankingHandler::deleteImageRanking)
                .andRoute(deleteImageRankingStatePredicate, imageRankingHandler::deleteRankingState)
    ...
    public RouterFunction<ServerResponse> tagRoute(final TagHandler tagHandler) {
        ...
        return RouterFunctions.route(getTagPredicate, tagHandler::getTagByName)
                ...
                .andRoute(deleteImageRankingTagsPredicate, tagHandler::deleteImageRankingTags)
                .filter(routeMetricsFilter);
    }
